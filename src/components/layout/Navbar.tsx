      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            {/* Grid Columns matching layout visual design */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12 md:mt-24 max-w-7xl mx-auto w-full">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <button onClick={() => handleLinkClick('home')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Home Base</button>
                  <button onClick={() => handleLinkClick('tournaments')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Tournaments</button>
                  <button onClick={() => handleLinkClick('leagues')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Leagues</button>
                  <button onClick={() => handleLinkClick('history')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Hall of Fame</button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <button onClick={() => handleLinkClick('ludo4schools')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Ludo 4 Schools</button>
                  <button onClick={() => handleLinkClick('donate')} className="relative group text-left block font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white hover:text-white transition-colors">
                  ...
                  <button onClick={() => handleLinkClick('about')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Identity & Vision</button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <button onClick={() => handleLinkClick('portal')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Player Portal</button>
                  <button onClick={() => handleLinkClick('contact')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Get in Touch</button>
                  <button onClick={() => handleLinkClick('admin')} className="text-left font-display font-black text-3xl md:text-5xl uppercase tracking-tight text-white/40 hover:text-white transition-colors">Secure Console</button>
                </div>
              </div>
