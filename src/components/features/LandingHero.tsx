...
export const LandingHero = ({ scrollToSection }: { scrollToSection: (id: string) => void }) => {
  return (
    <section id="home" className="h-screen w-full snap-start overflow-y-auto relative flex flex-col items-center justify-center border-b border-white/10">
      <LudoBoardDecoration />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 text-center mt-20">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button onClick={() => scrollToSection('history')} className="btn-action btn-action-outline w-full sm:w-auto bg-bg-deep/40 backdrop-blur-sm hover:bg-bg-deep/80">
              View History
            </button>
          </div>
        </motion.div>
