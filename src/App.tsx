...
export type Page = 'Landing' | 'Home' | 'Leagues' | 'Tournaments' | 'History' | 'Gallery' | 'Shop' | 'Contact' | 'Admin';
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting && params.get('page') !== 'admin') {
          ...
          if (themeColorMeta) {
            const colors: Record<string, string> = { home: '#FFFFFF', about: '#0F172A', leagues: '#0EA5E9', tournaments: '#0EA5E9', history: '#0F172A', gallery: '#0EA5E9', shop: '#0F172A', fund: '#0EA5E9', contact: '#0EA5E9' };
