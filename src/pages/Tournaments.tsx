...
export const Tournaments = () => {
  ...
  return (
    <section id="tournaments" className="h-screen w-full snap-start overflow-y-auto relative flex flex-col justify-center px-4 md:px-10 border-t-4 border-ludo-red bg-gradient-to-b from-ludo-red/10 to-bg-deep">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="w-full mt-24">
