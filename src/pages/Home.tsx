      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 text-center mt-8">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <div className="inline-block tag-status mb-6 text-[9px] md:text-[11px] bg-bg-deep/60 backdrop-blur-sm border-white/10">
            <span className="status-indicator"></span> Player Dashboard Portal
          </div>
          ...
          <p className="text-base sm:text-lg md:text-2xl text-white max-w-2xl mx-auto mb-10 font-medium leading-relaxed px-4 drop-shadow-lg">
            Welcome to the official web app. Register for upcoming qualifiers, manage your circuit status, and access official gear.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button onClick={() => setActivePage('Shop')} className="btn-action btn-action-outline w-full sm:w-auto bg-bg-deep/40 backdrop-blur-sm hover:bg-bg-deep/80">
              Access Official Shop
            </button>
          </div>
        </motion.div>
      </div>
