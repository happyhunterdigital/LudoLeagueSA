      ...
      <section className="py-24 px-6 md:px-10" id="ludo-agents" style={{ background: 'radial-gradient(ellipse at top, #0a1f1c 0%, #041a18 100%)' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-bold italic text-[#00c9a7] mb-4">Call for Ludo Agents</p>
            ...
            <p className="text-[#9abcb6] max-w-3xl mx-auto leading-relaxed">
              Ludo South Africa is inviting registered agencies and sports talent representatives to become Official Ludo Agents. As the sport continues to grow across the country, this is an opportunity to establish your agency within a new and emerging professional sporting ecosystem from the very beginning.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="theme-card">
              ...
              <h3 className="text-white mb-5">Your Responsibilities</h3>
              <ul className="space-y-3">
                {[
                  ...
                  'Prepare players for leagues, tournaments, championships, and other official events.',
                  'Work with Ludo South Africa to ensure players are available for competitions, media engagements, and commercial opportunities.',
            ...
            <div className="theme-card border-[#e8a020]/20">
              ...
              <h3 className="text-white mb-5">Why Become an Official Agent?</h3>
              <p className="text-[#9abcb6] text-sm leading-relaxed mb-4">
                As one of the first officially recognised Ludo agencies in South Africa, you'll have the opportunity to establish relationships with players at the grassroots level and grow alongside the sport. Agencies that invest early will be well positioned as the player pool, competitions, sponsorships, and commercial opportunities expand over time.
              </p>
              <p className="text-[#9abcb6] text-sm leading-relaxed">
                Your registered players remain your agency's responsibility and portfolio. Whenever they earn prize money, secure sponsorships, endorsements, appearance opportunities, or other approved commercial deals, your agency will be entitled to its agreed share in accordance with Ludo South Africa regulations and player representation agreements.
              </p>
            </div>
          </div>
          ...
          <div className="theme-card mb-8">
            ...
            <h3 className="text-white mb-6">Minimum Requirements</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                'Ensure every player under your agency is officially registered and accredited with Ludo South Africa.',
                'Comply with all Ludo South Africa rules, regulations, and the Official Agent Code of Conduct.',
              ].map((req, i) => (
          ...
          {/* Licensing Table */}
          <div className="theme-card mb-8 overflow-x-auto">
            <div className="p-3 bg-[#0a3d35] text-[#00c9a7] rounded-xl w-fit mb-6"><Briefcase size={24} /></div>
            <h3 className="text-white mb-6">Licensing Model</h3>
            <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  {['Licence Type', 'Initial Fee', 'Annual Renewal', 'Training'].map(h => (
                    <th key={h} className="text-left p-3 text-[#00c9a7] text-xs uppercase tracking-wider font-bold border-b border-[#0a3d35]">{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-3 text-[#9abcb6]">Academy Training</td>
                </tr>
            ...
            <p className="text-[#9abcb6] text-xs mt-4 opacity-70">
              ⚡ The Founding Agent Licence rewards early adopters, helps establish a national agent network quickly, and creates momentum without permanently discounting the value of the licence.
            </p>
          </div>

          {/* Academy Training Programme */}
          <div className="theme-card mb-8">
            <h3 className="text-white mb-3">Academy Training — 3-Day Programme</h3>
            <p className="text-[#9abcb6] text-sm mb-5">The academy focuses on practical knowledge rather than lengthy classroom sessions. A 3-day programme covers:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {[
                'Ludo South Africa rules and regulations',
                ...
                'Marketing and talent identification',
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-2 text-[#9abcb6] text-sm">
                  <span className="text-[#00c9a7] mt-0.5 flex-shrink-0">▸</span>
                  {item}
                </div>
              ))}
            ...
            <div className="mt-6 pt-5 border-t border-white/5">
              <p className="text-[#9abcb6] text-sm mb-2 font-semibold text-white/70">After training, candidates will:</p>
              <div className="flex flex-col sm:flex-row gap-4">
                {['Complete an assessment', 'Submit a practical case study', 'Sign the Agent Code of Conduct', 'Receive official licence and accreditation'].map((s, i) => (
                  <div key={i} className="flex items-center gap-2 text-[#9abcb6] text-sm">
                    <span className="text-[#e8a020]">✓</span> {s}
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="theme-card">
              <h3 className="text-white mb-5">Additional Revenue Streams</h3>
            ...
            <div className="theme-card border-[#00c9a7]/20">
              <h3 className="text-white mb-4">The Investment Perspective</h3>
              <p className="text-[#9abcb6] text-sm leading-relaxed mb-4">
                The key is that agents should see the licence as an investment in a long-term profession, not just a fee to participate. As the Ludo ecosystem grows — with more tournaments, sponsorships, media exposure, and player earnings — the value of holding an official licence will increase alongside it.
              </p>
              <p className="text-[#9abcb6] text-sm leading-relaxed">
                The professionalisation of Ludo is creating new opportunities beyond the game itself. Player representation will play an important role in shaping the future of the sport, and Ludo South Africa is looking for agencies ready to help build that future.
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <a
              href="https://academy.ludoleague.co.za"
              target="_blank"
              rel="noreferrer"
              className="inline-block px-10 py-4 rounded-full font-black italic uppercase tracking-wider text-[#041a18] transition-all duration-300 hover:scale-105 hover:shadow-2xl"
              style={{ background: 'linear-gradient(135deg, #e8a020, #f4c84a)', boxShadow: '0 4px 20px rgba(232,160,32,0.4)' }}
            >
